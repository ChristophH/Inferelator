...
plot.tf <- function(des.mat, res.mat, exp.mat, tf, net, prior, tfa.mat, fn, width=18, height=9, dpi=100) {
  ...
  # subset the expression matrix since it may have more columns than design and response
  # (the last points of time series are not in design and response)
  exp.mat <- exp.mat[rownames(res.mat), colnames(res.mat)]
  ...
  # for the heatmap
  fn.hm <- gsub('.png', '_heatmap_prior.png', fn)
  goi <- p.tar
  if (length(goi) > 1) {
    hm.res.mat <- res.mat[goi, , drop=FALSE]
    cols <- rep('white', length(goi))
...
#v30.small.pr <- '/home/ch1421/Projects/Rice/inferelator_output/151013_590bp_open_expr_adjpth001_exprtfs_incl_autoreg_merged005_filtered_32_sspr_BBSR_1.1_41/combinedconf_frac_tp_100_perm_1--frac_fp_0_perm_1_1.1.RData'

#v31.small.pr <- '/home/ch1421/Projects/Rice/inferelator_output/151013_590bp_open_expr_adjpth001_exprtfs_incl_autoreg_merged005_filtered_32_sspr_BBSR_1.1_201/combinedconf_frac_tp_100_perm_1--frac_fp_0_perm_1_1.1.RData'
#cc.v32 <- '/home/ch1421/Projects/Rice/inferelator_output/151013_590bp_open_expr_adjpth001_exprtfs_incl_autoreg_merged005_sspr_BBSR_1.1_201/combinedconf_frac_tp_100_perm_1--frac_fp_0_perm_1_1.1.RData'

#vis.tfs.and.targets(v31.small.pr, CORES=4)
